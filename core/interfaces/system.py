...
class IProcessTracker(Protocol):
    ...
    def fetch_unexpected_stops(
        self, bots: dict[str, BotConfig], spawner: IProcessSpawner | None = None
...
class IGitClient(Protocol):
    ...
    def get_commit_details(self, repo_path: str, rev: str = "HEAD") -> dict[str, str] | None: ...
...
__all__ = ["ILogRotator", "IProcessSpawner", "IProcessTracker", "IGitClient", "IMetricsCollector"]
